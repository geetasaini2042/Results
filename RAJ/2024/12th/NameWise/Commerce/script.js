...
const checkAnotherUrl = "https://geetasaini2042.github.io/Results/RAJ/2024/12th/NameWise/Commerce";
...
function sendResult(name, btn, ad) {
  const sourceUrl = `https://rj-12-commerce-result.indiaresults.com/rj/bser/class-12-commerce-result-2024/mname-results.aspx`;
    ...
    .then(response => {
      if (response.status === 200) {
        ...
        return response.text().then(text => {
          ...
          ad.innerHTML = `<div style="color: red; font-weight: bold;">No Record Found!</div>`;
          resetButton(btn);
